    ...
    <View style={styles.container}>
       <View style={styles.cont_sup}/>   
        <View style={styles.cont_image}>
            <Image source={{ uri: 'https://preview.redd.it/pedi-pra-ia-dalle-2-criar-o-rosto-brasileiro-mais-real-e-v0-75b76dc8jng91.png?width=640&crop=smart&auto=webp&s=ef23659d09ed352b795ad65b9012ec3fa650ed16' }} style={styles.image} />
            <View style={styles.cont_btn_edit}><EvilIcons name="pencil" size={35} color="black" /></View>
        </View>
        <View style={styles.cont_space}/>
      <View style={styles.line}>
         <Text style={styles.title}>Sunmhk</Text>
         <Text style={styles.title}>{' '}Norman</Text>
      </View>   
      <View style={styles.line}>
     ...
     {user.tipo === 'ADM' && 
        ...
        <TouchableOpacity  style={styles.btnsmenu} onPress={() => handleNavigate('Register')}>
